...
export const ComingSoon = () => {
  return (
    <BackgroundCard className='flex-1 flex-row-reverse lg:flex-row hover:scale-105 transition-transform cursor-pointer'>
      <a
        target='_blank'
        href='https://www.oox.art/marketplace/collections/SMARUGON-69bfc0'
